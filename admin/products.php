...
<section class="add-products">
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="Cold Drinks and Juices">Cold Drinks and Juices</option>
         <option value="Sweet Tooth">Sweet Tooth</option>
         <option value="Biscuit and Cakes">Biscuit and Cakes</option>
         <option value="Cereals and Breakfast">Cereals and Breakfast</option>
         <option value="Sauces and Spreads">Sauces and Spreads</option>
         <option value="Tea, Coffee and More">Tea, Coffee and More</option>
         <option value="Meat and Seafood">Meat and Seafood</option>
         <option value="Instant and Frozen Food">Instant and Frozen Food</option>
      </select>
